...
export default function CompanyCategoryCreate() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await api.post('/en/api/v1/company/category/create/', formData);
      navigate(`/company/categories/${response.body.data.id}`);
    } catch (err) {
        ...
        <div className="flex-1 p-5 mt-[6%]">
          <div className="max-w-4xl mx-auto">
            <div className="flex justify-between items-center mb-6">
              <h1 className="text-3xl font-bold text-white">Create New Company Category</h1>
              <button
