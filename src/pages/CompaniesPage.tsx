          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="text-gray-300">
                ...
                {Math.min(companiesData.currentPage * companiesData.perPage, companiesData.totalResults)} of {companiesData.totalResults} companies
              </div>
            </div>
                ...
                <div className="flex items-center justify-between px-4 py-3 bg-gray-800 rounded-lg">
                  <div>
                    <p className="text-sm text-gray-400">
                      Page <span className="font-medium">{companiesData.currentPage}</span> of <span className="font-medium">{totalPages}</span>
                    </p>
                  </div>
                  <div className="flex space-x-2">
                    <button
                      ...
                      className={`px-4 py-2 rounded-md ${companiesData.currentPage === 1 ? 'bg-gray-700 text-gray-500 cursor-not-allowed' : 'bg-gray-700 text-white hover:bg-gray-600'}`}
                    >
                      Previous
                    </button>
                    {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
                      <button
                        ...
                        className={`px-4 py-2 rounded-md ${companiesData.currentPage === page ? 'bg-blue-600 text-white' : 'bg-gray-700 text-white hover:bg-gray-600'}`}
                      >
                        {page}
                      </button>
                    ))}
                    <button
                      ...
                      className={`px-4 py-2 rounded-md ${companiesData.currentPage === totalPages || totalPages === 0 ? 'bg-gray-700 text-gray-500 cursor-not-allowed' : 'bg-gray-700 text-white hover:bg-gray-600'}`}
                    >
                      Next
                    </button>
                  </div>
