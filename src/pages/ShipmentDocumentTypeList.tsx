                        ...
                        {documentTypes.map((docType) => {
                          ...
                          return (
                            <tr key={docType.id} className="hover:bg-gray-700 transition-colors">
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-300">{docType.id}</td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-white">{docType.title}</td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-300">{docType.order}</td>
