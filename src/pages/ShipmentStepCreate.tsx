...
export default function ShipmentStepCreate() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await api.post("/en/api/v1/shipment/step/create/", formData);
      navigate(`/shipment/steps/${response.body.data.id}`);
    } catch (err) {
        ...
        <div className="flex-1 p-5 mt-[5%]">
          <div className="max-w-4xl mx-auto">
            <div className="flex justify-between items-center mb-6">
              <h1 className="text-3xl font-bold text-white">Create New Step</h1>
              <button
