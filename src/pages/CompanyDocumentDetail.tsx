                ...
                <>
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-white">{document.company?.name}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-400">Document Type</p>
                      <p className="text-white">{document.type?.title}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-400">Verifier</p>
                      <p className="text-white">{document.verifier?.email}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-400">File Type</p>
                      <p className="text-white">{getFileType(document.file)}</p>
                    </div>
                    <div>
