      ...
      <FormItem>
        ...
        <input
          ...
          className={cn(
            ...
            "file:mb-1 file:cursor-pointer file:rounded-md file:border file:border-solid file:border-primary file:bg-blue-50 file:text-sm file:font-medium file:text-primary hover:file:bg-blue-100",
            type === "file" && "py-1.5",
            inputStyles({ variant }),
            className,
          )}
