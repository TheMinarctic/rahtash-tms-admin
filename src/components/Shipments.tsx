...
const Shipments = () => {
  ...
  return (
    <>
      <div className="mt-0 shadow-md p-5 px-7 rounded-lg">
        ...
        <Table className="table">
          <TableHeader>
            ...
            <TableColumn className="text-black text-start bg-green-500">
              Port of Loading
            </TableColumn>
            <TableColumn className="text-black text-start bg-green-500 hidden xl:table-cell">
              Port of Discharge
            </TableColumn>
            <TableColumn className="text-black text-start bg-green-500 hidden xl:table-cell">
              Place of Delivery
